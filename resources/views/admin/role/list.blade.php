    ...
    <div class="card">
        <div class="card-body">
            ...
            <span style="float: right; margin-top: 10px;" >
                <a class="text-center btn btn-primary" href="{{URL::route('add-role')}}" >Add Role</a>
            </span>
            <table class="dt-multilingual table border-top" id="role_table" >
                <thead>
                    <tr>
