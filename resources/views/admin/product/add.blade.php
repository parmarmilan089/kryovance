            ...
            <div class="card-body">
                ...
                <form id="form_add_product" method="POST" action="{{ route('store-product') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="price_seller" name="percentage_seller"
                                placeholder="Enter Seller Percentage" value="{{ old('percentage_seller') }}" />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="percentage_distributor" name="percentage_distributor"
                                placeholder="Enter Distributor Percentage" value="{{ old('percentage_distributor') }}" />
                    ...
                    <div class="row mb-3">
                        <label for="percentage_government" class="col-sm-2 col-form-label">Government Employee Percentage</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="percentage_government" name="percentage_government"
                                placeholder="Enter Government Employee Percentage" value="{{ old('percentage_government') }}" />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="percentage_retailer" name="percentage_retailer"
                                placeholder="Enter Retailer Percentage" value="{{ old('percentage_retailer') }}" />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="percentage_wholesaler" name="percentage_wholesaler"
                                placeholder="Enter Wholesaler Percentage" value="{{ old('percentage_wholesaler') }}" />
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('#inventory_id').append('<option value="' + value.id + '">' +
                                value.model_name + ' - Qty: ' + value.qty + '</option>');
                        });
                    }
                });
            } else {
