                ...
                @foreach ($latestProducts as $item)
                    ...
                    <div class="col-md-3">
                        <div class="hotproduct-cart">
                            ...
                            <div class="hotP-img">
                                <figure>
                                    <img src="{{ $item->image_url ? $item->image_url : asset('user/assets/images/15980049.png') }}" alt="{{ $item->product_name }}" />
                                </figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                    type="button" role="tab" aria-controls="home" aria-selected="true">HP Printer</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                    type="button" role="tab" aria-controls="profile" aria-selected="false">Kodak
                                    Printers</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                                    type="button" role="tab" aria-controls="contact" aria-selected="false">Kodak Thermal
                                    Media</button>
                            </li>
                        </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="productCart-flex">
                                            <figure>
                                                <img src="{{asset('user/assets/images/product-1.jpg')}}" alt="" />
                                            </figure>
                                            ...
                                            <div class="cart-ctaflex">
                                                ...
                                                <div class="cart-cta"><button><img
                                                            src="{{asset('user/assets/images/cart-icon-w.svg')}}"
                                                            alt="" /></button></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="minimal_product_item">
                                        ...
                                        <div class="item_content">
                                            <h3 class="item_title">
                                                <a
                                                    href="{{ route('product_details', $product->id) }}">{{ \Illuminate\Support\Str::limit($product->name, 40, '..') }}</a>
                                            </h3>
