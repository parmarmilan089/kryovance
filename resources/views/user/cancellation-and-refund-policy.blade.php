...
<!-- main body - start
    ...
    <main>
        ...
        <section class="breadcrumb_section text-white text-center text-uppercase d-flex align-items-end clearfix" >
            ...
            <div class="container">
                <h1 class="page_title text-white">Cancellation and Refund Policy
</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="whyMainContent">
                    ...
                    <p>
                       At Kryovance, we strive to ensure customer satisfaction. Orders can be canceled before they are shipped by contacting <a href="">sales@slsyn.com.</a> Once shipped, cancellation requests will not be accepted.

                    </p>
                    <p>
                       Refunds will be processed in the following scenarios:

                    </p>
                    <ul>
                        <li>If a product is out of stock after order confirmation.</li>
                        <li>If the order is canceled before shipping.</li>
                        <li>If you receive a defective, damaged, or incorrect item (must be reported within 48 hours of delivery).</li>
