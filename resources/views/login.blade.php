...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('admin/assets/vendor/quill/quill.snow.css') }}" />
        <link rel="stylesheet" href="{{ URL::asset('admin/assets/vendor/quill/quill.bubble.css') }}" />
