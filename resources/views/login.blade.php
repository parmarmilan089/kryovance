...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('/public/admin/assets/vendor/quill/quill.snow.css') }}" />
        <link rel="stylesheet" href="{{ URL::asset('/public/admin/assets/vendor/quill/quill.bubble.css') }}" />
                            ...
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="d-flex justify-content-center py-4">
                                    <a href="index.html" class="logo d-flex align-items-center w-auto">
                                        ...
                                        <span class="d-none d-lg-block">Kryovance</span>
                                    </a>
                                </div><!-- End Logo -->
